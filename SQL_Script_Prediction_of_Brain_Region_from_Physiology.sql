...
COPY allen_neuropixel.metrics_brain_observatory 
	FROM 'C:/Users/Public/brain_observatory_1.1_analysis_metrics.csv' WITH CSV HEADER;
...
COPY allen_neuropixel.metrics_functional_connectivity 
	FROM 'C:/Users/Public/functional_connectivity_analysis_metrics.csv' WITH CSV HEADER;
...
COPY allen_neuropixel.units 
	FROM 'C:/Users/Public/units.csv' WITH CSV HEADER;
...
COPY allen_neuropixel.channels 
	FROM 'C:/Users/Public/channels.csv' WITH CSV HEADER;
...
SELECT ugood.id, ch.ecephys_structure_acronym INTO allen_neuropixel.temp_good_units 
	FROM (SELECT u.id,u.ecephys_channel_id FROM allen_neuropixel.units as u WHERE u.quality='good') as ugood 
	INNER JOIN allen_neuropixel.channels as ch ON (ugood.ecephys_channel_id=ch.id);
...
SELECT bo.c50_dg, bo.area_rf,bo.fano_dg, bo.fano_fl,bo.fano_ns, bo.fano_rf ,bo.fano_sg , bo.f1_f0_dg ,bo.g_dsi_dg,
	...
	INTO allen_neuropixel.temp_bo_vis FROM allen_neuropixel.metrics_brain_observatory as bo 
	INNER JOIN (SELECT goodu.id FROM allen_neuropixel.temp_good_units as goodu WHERE goodu.ecephys_structure_acronym IN 
				(SELECT vc.ecephys_structure_acronym FROM allen_neuropixel.visual_cortex_labels as vc)) as ufilt ON 
				(bo.ecephys_unit_id=ufilt.id); 

COPY allen_neuropixel.temp_bo_vis TO 'C:/Users/Public/Brain_Observatory_Visual_Cortex.csv' WITH CSV HEADER;
...
SELECT bo.c50_dg, bo.area_rf,bo.fano_dg, bo.fano_fl,bo.fano_ns, bo.fano_rf ,bo.fano_sg , bo.f1_f0_dg ,bo.g_dsi_dg ,
	...
	bo.pref_images_multi_ns ,bo.lifetime_sparseness_dg , bo.lifetime_sparseness_fl ,bo.lifetime_sparseness_ns , 
	bo.lifetime_sparseness_rf ,bo.lifetime_sparseness_sg 
	INTO allen_neuropixel.temp_bo_hf FROM allen_neuropixel.metrics_brain_observatory as bo INNER JOIN 
	(SELECT goodu.id FROM allen_neuropixel.temp_good_units as goodu WHERE goodu.ecephys_structure_acronym IN 
	 (SELECT hf.ecephys_structure_acronym FROM allen_neuropixel.hippocampal_formation_labels as hf)) as ufilt 
	 ON (bo.ecephys_unit_id=ufilt.id); 

COPY allen_neuropixel.temp_bo_hf TO 'C:/Users/Public/Brain_Observatory_Hippocampal_Formation.csv' WITH CSV HEADER;
...
SELECT fc.c50_dg, fc.area_rf,fc.fano_dg, fc.fano_dm ,fc.fano_fl,fc.fano_rf, fc.f1_f0_dg,fc.g_dsi_dg, fc.g_osi_dg, 
	...
	INTO allen_neuropixel.temp_fc_vis FROM allen_neuropixel.metrics_functional_connectivity as fc INNER JOIN 
	(SELECT goodu.id FROM allen_neuropixel.temp_good_units as goodu WHERE goodu.ecephys_structure_acronym IN 
	 (SELECT vc.ecephys_structure_acronym FROM allen_neuropixel.visual_cortex_labels as vc)) as ufilt 
	 ON (fc.ecephys_unit_id=ufilt.id); 

COPY allen_neuropixel.temp_fc_vis TO 'C:/Users/Public/Functional_Connectivity_Visual_Cortex.csv' WITH CSV HEADER;
...
SELECT fc.c50_dg, fc.area_rf,fc.fano_dg, fc.fano_dm ,fc.fano_fl,fc.fano_rf, fc.f1_f0_dg,fc.g_dsi_dg, fc.g_osi_dg, 
	...
	fc.pref_tf_multi_dg ,fc.sustained_idx_fl, fc.pref_dir_multi_dg,fc.pref_ori_multi_dg,fc.pref_speed_multi_dm,
	fc.lifetime_sparseness_dg, fc.lifetime_sparseness_dm, fc.lifetime_sparseness_fl,fc.lifetime_sparseness_rf 
	INTO allen_neuropixel.temp_fc_hf FROM allen_neuropixel.metrics_functional_connectivity as fc INNER JOIN 
	(SELECT goodu.id FROM allen_neuropixel.temp_good_units as goodu WHERE goodu.ecephys_structure_acronym IN 
	 (SELECT hf.ecephys_structure_acronym FROM allen_neuropixel.hippocampal_formation_labels as hf)) as ufilt 
	 ON (fc.ecephys_unit_id=ufilt.id); 

COPY allen_neuropixel.temp_fc_hf TO 'C:/Users/Public/Functional_Connectivity_Hippocampal_Formation.csv' WITH CSV HEADER;
